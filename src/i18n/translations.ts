...
export const TRANSLATIONS: Record<Language, Translations> = {
  en: {
    ...
    voyage: {
      ...
      pushingDialogues: [
        '“Rowing our sturdy paddle! The crisp arctic breeze feels amazing 🌊”',
        '“Hold onto your hot cocoa, cruising full steam ahead! ☕”',
        '“Deep breath, setting our compass for new horizons! 🧭”',
        '“Under the dancing auroras, sailing forward together ✨”',
      ],
    },
  },
  zh: {
